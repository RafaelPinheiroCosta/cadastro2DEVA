...
public class Usuario {
    ...
    /*
     * Este campo nao guarda mais a senha original.
     *
     * Ele armazena o hash BCrypt.
     *
     * Por isso a coluna precisa ser maior que os
     * 8 caracteres permitidos para a senha de entrada.
     */
    @Column(
            name = "senha",
            nullable = false,
